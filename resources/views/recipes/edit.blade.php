...
<div class="container-md mt-4">
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" id="category" name="category" required>
                        ...
                        <option value="ayam" {{ old('category') == 'ayam' ? 'selected' : '' }}>Ayam</option>
                        <option value="bayi dan anak" {{ old('category') == 'bayi dan anak' ? 'selected' : '' }}>Bayi dan
                            Anak</option>
                        <option value="cemilan" {{ old('category') == 'cemilan' ? 'selected' : '' }}>Cemilan</option>
                        <option value="kue" {{ old('category') == 'kue' ? 'selected' : '' }}>Kue</option>
                        <option value="ikan" {{ old('category') == 'ikan' ? 'selected' : '' }}>Ikan</option>
                        <option value="eskrim" {{ old('category') == 'eskrim' ? 'selected' : '' }}>Es Krim</option>
                        <option value="mie" {{ old('category') == 'mie' ? 'selected' : '' }}>Mie</option>
                        <option value="minuman" {{ old('category') == 'minuman' ? 'selected' : '' }}>Minuman</option>
                        <option value="sate" {{ old('category') == 'sate' ? 'selected' : '' }}>Sate</option>
                                ...
                                <div class="d-flex align-items-start">
                                    ...
                                    <div class="flex-grow-1 ml-3">
                                        <textarea class="form-control mb-2" name="instructions[]"
                                            placeholder="Masukkan instruksi" rows="3" required>{{ $instruction }}</textarea>
    ...
    `;
        ...
        // Panggil updateInstructionLabels saat halaman dimuat untuk memastikan nomor instruksi terupdate
        updateInstructionLabels();
