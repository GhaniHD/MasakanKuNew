@extends('layouts.app')
<!-- resources/views/user/allRecipe.blade.php -->
...
<style>
    ...
    .category-grid .category-item {
        ...
        max-width: 80px;
        /* Ukuran maksimum lebar box */
        max-height: 80px;
        /* Ukuran maksimum tinggi box */
    }
    ...
    .category-grid .category-item:hover i {
...
<body>
    <section class="py-1">
        <div class="container px-4 px-lg-2 mt-1">
            <!-- Section Baru untuk Grid Kategori -->
            <div style="justify-content: center;">
                <h1>Kategori</h1>
            </div>
            <div class="category-grid">
                <div class="category-item" data-category="ayam" onclick="navigateToCategory(this)">
                    <i class="fa fa-drumstick-bite"></i>
                    <span>AYAM</span>
                </div>
                <div class="category-item" data-category="bayi-anak" onclick="navigateToCategory(this)">
                    <i class="fa fa-child"></i>
                    <span>BAYI & ANAK</span>
                </div>
                <div class="category-item" data-category="bebek" onclick="navigateToCategory(this)">
                    <i class="fa fa-drumstick-bite"></i>
                    <span>SALAD</span>
                </div>
                <div class="category-item" data-category="cemilan" onclick="navigateToCategory(this)">
                    <i class="fa fa-cookie"></i>
                    <span>CEMILAN</span>
                </div>
                <div class="category-item" data-category="daging" onclick="navigateToCategory(this)">
                    <i class="fa fa-drumstick-bite"></i>
                    <span>MIE</span>
                </div>
                <div class="category-item" data-category="es-krim" onclick="navigateToCategory(this)">
                    <i class="fa fa-ice-cream"></i>
                    <span>ES KRIM</span>
                </div>
                <div class="category-item" data-category="gulai" onclick="navigateToCategory(this)">
                    <i class="fa fa-bowl-rice"></i>
                    <span>SATE</span>
                </div>
                <div class="category-item" data-category="ikan" onclick="navigateToCategory(this)">
                    <i class="fa fa-fish"></i>
                    <span>IKAN</span>
                </div>
                <div class="category-item" data-category="jajanan" onclick="navigateToCategory(this)">
                    <i class="fa fa-cupcake"></i>
                    <span>JAJANAN</span>
                </div>
                <div class="category-item" data-category="jus" onclick="navigateToCategory(this)">
            ...
            <div class="row">
                <div class="col-md-12">
                    <h1 class="decorated-text">Semua Resep</h1>
